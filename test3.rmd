...
Stein_Table_datatable2[3,c(8:11)] <- "--do--"
Stein_Table_datatable2[8,c(8:11)] <- "--do--"
Stein_Table_datatable2[8,c(2:6)] <- "--do--"
Stein_Table_datatable2[c(25,53,56,58,71,85,104,115,128),c(2:6)] <- "--do--"
Stein_Table_datatable2[c(25,53,56,58,71,85,104,115,128),c(8:11)] <- "--do--"
...
Stein_Table_datatable2[c(48,49,50,80,81,82,107,108,109),c(8:11)] <- "--do--"
Stein_Table_datatable2[c(135:139),c(2:6)] <- "--do--"
Stein_Table_datatable2[c(135:139),c(8:11)] <- "--do--"
...
```{r}
filter_slider("Year", "Year of Award", Stein_Table_sd, ~Year, step = 1, ticks = TRUE, animate = FALSE)
...
"Call Number(If Copy Available in the Library):", Stein_Table_dataframe$`Call Number (If Copy Available in the Library)`,"<br>"))%>%addLegend(position = "bottomleft", pal = pal, values = c("Category A: Support for Senior Scholarly Research", "Category B: Support for Student Research", "Category C: Support for Stein Sites"), opacity = 1)%>%addScaleBar()
```
